...
public class LambdaFunction implements RequestStreamHandler {
    ...
    public void handleRequest(InputStream inputStream, OutputStream outputStream, Context context) throws IOException {
        ...
        this.plugins = inputType.getPlugins();
        ArrayList<Plugin> pluginsLambdaResult = plugins();
        {
            OutputType outputType = new OutputType(this.plugindirconf, this.plugins, this.currentimage, this.plugins, pluginsLambdaResult);
