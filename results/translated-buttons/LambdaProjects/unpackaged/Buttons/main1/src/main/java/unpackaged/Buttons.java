...
public class Buttons extends Frame implements ActionListener {
    ...
    public void showwindow() {
        ...
        try {
            ...
            outputType = objectMapper.readValue(byteBufferToString(lambdaClient.invoke(invokeRequest).getPayload(), Charset.forName("UTF-8")), awsl.unpackaged.Buttons.showwindow.OutputType.class);
        } catch (Exception e) {
        }
        ;
    }
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        try {
            ...
            invokeRequest.setFunctionName(functionName);
            invokeRequest.setPayload(json);
            outputType = objectMapper.readValue(byteBufferToString(lambdaClient.invoke(invokeRequest).getPayload(), Charset.forName("UTF-8")), awsl.unpackaged.Buttons.actionPerformed1.OutputType.class);
        } catch (Exception e) {
        }
        ;
    }
