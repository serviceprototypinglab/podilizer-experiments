package awsl.calculator4.Calculator4ConcreteListener.exitPrint1;
...
public class InputType {
    ...
    public void setCtx(PrintContext ctx) {
        this.ctx = ctx;
    }

    public PrintContext getCtx() {
        return ctx;
    }

    public InputType(Stack<Integer> stack, Map<String, Integer> sym, PrintContext ctx) {
        this.stack = stack;
        this.sym = sym;
        this.ctx = ctx;
    }
