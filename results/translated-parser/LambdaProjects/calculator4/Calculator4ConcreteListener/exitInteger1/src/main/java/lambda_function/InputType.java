...
public class InputType {
    ...
    public void setCtx(IntegerContext ctx) {
        this.ctx = ctx;
    }

    public IntegerContext getCtx() {
        return ctx;
    }

    public InputType(Stack<Integer> stack, Map<String, Integer> sym, IntegerContext ctx) {
        this.stack = stack;
        this.sym = sym;
        this.ctx = ctx;
    }
