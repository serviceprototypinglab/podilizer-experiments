package awsl.calculator4.Calculator4ConcreteListener.exitAssignment1;
...
public class InputType {
    ...
    public void setCtx(AssignmentContext ctx) {
        this.ctx = ctx;
    }

    public AssignmentContext getCtx() {
        return ctx;
    }

    public InputType(Stack<Integer> stack, Map<String, Integer> sym, AssignmentContext ctx) {
        this.stack = stack;
        this.sym = sym;
        this.ctx = ctx;
    }
